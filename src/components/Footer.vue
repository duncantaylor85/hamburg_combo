<template>
  <div class="footer">
    <v-footer padless color="blue-grey lighten-5">
      <v-card tile flat class="mx-auto" color="blue-grey lighten-5">
        <v-card-text>
          <v-btn href="https://www.youtube.com/channel/UC7zTuLQ3XWC-lXbacqCjjQg" target="_blank" color="red" icon class="mx-2">
      ...
      <v-card tile flat class="mx-auto" color="blue-grey lighten-5">
        <v-card-text class="pt-0">
          ...
          <h2 class="mb-4">Angaben gem&auml;&szlig; &sect; 5 TMG</h2>
          <p>
            Duncan Taylor<br />
            Braamkamp 16<br />
            22297 Hamburg
          ...
          <h2>Kontakt</h2>
          <p>
            E-Mail: duncantaylor@mailbox.org
          </p>

          <h3>Haftung f&uuml;r Inhalte</h3>
          <p>
            Als Diensteanbieter sind wir gem&auml;&szlig; &sect; 7 Abs.1 TMG f&uuml;r eigene Inhalte auf diesen Seiten nach den allgemeinen Gesetzen verantwortlich. Nach &sect;&sect; 8 bis 10 TMG sind
            wir als Diensteanbieter jedoch nicht verpflichtet, &uuml;bermittelte oder gespeicherte fremde Informationen zu &uuml;berwachen oder nach Umst&auml;nden zu forschen, die auf eine
            rechtswidrige T&auml;tigkeit hinweisen.
          </p>
          <p>
            Verpflichtungen zur Entfernung oder Sperrung der Nutzung von Informationen nach den allgemeinen Gesetzen bleiben hiervon unber&uuml;hrt. Eine diesbez&uuml;gliche Haftung ist jedoch erst ab
            dem Zeitpunkt der Kenntnis einer konkreten Rechtsverletzung m&ouml;glich. Bei Bekanntwerden von entsprechenden Rechtsverletzungen werden wir diese Inhalte umgehend entfernen.
          </p>
        ...
        <v-card-text class="text-center"> {{ new Date().getFullYear() }} — <strong>Hamburg Combo</strong> </v-card-text>
      </v-card>
    </v-footer>
  </div>
</template>
